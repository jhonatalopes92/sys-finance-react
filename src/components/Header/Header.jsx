    ...
    return(
        <header className="bg-[#f1f1f1] flex justify-between items-center p-4 h-[10%]">
                ...
                <div className="space-x-4 flex">
                    ...
                    <button className="bg-[#118dc0] py-1 px-4 text-white rounded hover:bg-[#426b7b] transition-all duration-300 flex items-center gap-2"><Plus size={15} /> Novo produto</button>
                </div>
            </header>
    )
}
